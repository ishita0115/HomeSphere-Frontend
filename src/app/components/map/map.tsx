...
export default function Mapcompo({ latitude, longitude ,address}) {
  ...
  return (
    ...
    <div className="flex dark:bg-gray-900 items-center justify-center">
      ...
      />
        ...
        <Marker position={markerPosition} draggable={true} eventHandlers={{ dragend: handleMarkerDragEnd }}  icon={housingIcon}>
          <Popup>
            Adress:{address}
          </Popup>
        </Marker>
