...
//     <>
// <footer
//   className="flex flex-col w-full mx-auto items-center mt-5 bg-[#0082cc] text-center text-white">
...
//           <div className=" w-full mx-auto items-center mt-5 bg-[#0082cc] text-center text-white">
//             <div className="container">
//               <div className="">
